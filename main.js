...
function analyzeGroup(string) {
	...
	let imsGroup = ['ЛИ', 'ЛЛ', 'ЛН', 'ЛА', 'ЛЕ', 'ЛС', 'ЛБ', 'ЛР', 'ЛК', 'ЛК', 'ЛД', 'ЛП', 'ТВ', 'ТР', 'ТМ', 'ТТ', 'ТД', 'ТЛ', 'ТК', 'ТП'],
			imsGroupAns = ["і (кон'юнктор), ", "або (альт-або), ", "не (інвертор), ", "і-не (штрих шефера), ", "або-не (стрілка пірса), ", "і-або (комплексні МС), ", "і-не, або-не (комплексні мс, стрілка + штрих), ", "і-або-не (комплексні МС і полярними входами), ", "і-або-не, і-або (комплексні МС с полярними входами, стрілка + штрих), ", "або-не, або, ", "розширені, ", "інші, ", "JK, ", "RS, ", "D, ", "T, ", "динамічний, ", "тригер Шмітта, ", "тригер комбінований, ", "специфічні тригери', "]
